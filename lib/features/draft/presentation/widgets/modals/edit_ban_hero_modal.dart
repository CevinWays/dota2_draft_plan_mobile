...
class EditBanHeroModal extends StatefulWidget {
  ...
  @override
  State<EditBanHeroModal> createState() => _EditBanHeroModalState();
}

class _EditBanHeroModalState extends State<EditBanHeroModal> {
    ...
    return BlocListener<EditDraftItemCubit, EditDraftItemState>(
      listener: (context, state) {
        if (state is EditDraftItemSuccess) {
          Navigator.of(
            context,
          ).pop(true); // Return true when updated successfully
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText:
                      'Enter reasoning for banning this hero... e.g. Scales too hard against our support picks in the late game.',
